...
- 4 - **funciones**: parametros opcionales, varios parametros, spread operator con multiparametros, return, sobrecarga de funciones, funciones asíncronas, funciones generadoras
